...
function FormInv() {
  ...
  useEffect(() => {
        ...
        try {
          ...
          if (data) {
            ...
            const correoResponse = await fetch(
              "http://localhost/RegistrAgil/RegistrarInvitado/devolverDatosAcompanante.php",
              {
                method: "POST",
                headers: {
    ...
    getDataTable(
      "http://localhost/RegistrAgil/RegistrarInvitado/desencriptarAcom.php"
    );
  }, []);
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost/RegistrAgil/RegistrarInvitado/RegistrarAcom.php",
        {
          method: "POST",
          mode: "cors",
          body: formDataToSend,
                  ...
                  <Col xs={12} lg={4} className="d-flex align-items-center justify-content-center">
                    <Container className="text-center">
                      <Image
                        ...
                        className="rounded-circle Usuario card-foto mb-3"
                      />
                    </Container>
                  </Col>
                  <Col xs={12} lg={8}>
