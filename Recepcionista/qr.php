    ...
    if(session_status()== PHP_SESSION_ACTIVE){
        ...
        $mysqli->set_charset('utf8');
            ...
            if($qr=buscarDB('codigoqr', 'id_Codigo', $codigo))
            {
                ...
                if($qr['id_Acompañante'] !== NULL){
                    $id_Invitado = $qr['id_Acompañante'];
                    $nombreTabla = "acompañante";
                    $nombreColumna = "id_Acompañante";
                }else{
                    $id_Invitado = $qr['id_Invitado'];
                    $nombreTabla = "invitado";
                    $nombreColumna = "id_Invitado";
                }

                //comprobar si hay invitado registrado con el id del invitado
                if($inv=buscarDB($nombreTabla, $nombreColumna, $id_Invitado))
                {
