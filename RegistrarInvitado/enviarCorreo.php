            ...
            <main>
                <div class="container">
                    <section style="text-align: center;">
                        <p>Es un placer para nosotros informarte que estás invitado a una reunión en
                            <strong>'.$empresa.'</strong>.</p>
                    </section>
                    <section style="margin-bottom: 30px;">
                        <h2 style="font-size: 18px; margin-bottom: 10px;">Detalles de la Reunión:</h2>
                        <ul>
                            <li>Fecha: '.$fecha.'</li>
                            <li>Hora: '.$hora.'</li>
                            <li>Sala: '.$sala.'</li>
                    ...
                    <section style="margin-bottom: 30px;">
                        <h2 style="font-size: 18px; margin-bottom: 10px;">Asunto de la Reunión:</h2>
                        <ul>
                            <li>'.$descripcion.'</li>
                        </ul>
                    </section>
                    <section style="text-align: center;">
                        <h2 style="font-size: 18px; margin-bottom: 10px; text-align: left;">Registro previo:</h2>
                        <p>Para prepararnos para tu visita y facilitar tu acceso a nuestras instalaciones, es necesario realizar
                            tu registro previo en el siguiente enlace:</p>
                        <a href="'.$enlaceFormulario.'" class="btn-registro" style="color: white;">REGISTRAR</a>
                        <p>Al completar tu registro, recibirás un <i>usuario</i> y <i>contraseña</i> para ingresar a
                            <strong>RegistrÁgil</strong> y descargar
                            tu <strong>código QR de acceso</strong>. Este código es necesario para entrar al edificio el día de
                            la reunión.</p>
                        <p style="margin-top: 30px;">Esperamos contar con tu presencia.</p>
                    </section>
                    <section style="margin-top: 30px; margin-bottom: 30px;">
                        <h2 style="font-size: 18px; margin-bottom: 10px;">Anfitrión:</h2>
                        <ul>
