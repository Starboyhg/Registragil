...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //Recogemos el arreglo nuevos_equipos que contiene los nuevos equipos
    $nuevosEquipos = $dataArray["nuevos_equipos"];
    ...
    //Cachamos fecha, horaInicio y sala
    $fechaFront = $dataArray["fecha"];
    $horaInicioFront = $dataArray["horaInicio"];
    $salaFront = $dataArray["sala"];
    ...
    $select_checar_equipo = "SELECT * FROM dispositivo WHERE id_Invitado = '$id_invi' AND fecha = '$fechaFront' AND horaInicio = '$horaInicioFront'";
    ...
    if (($conteo->num_rows > 0) ) {
        ...
        //Actualizamos cada uno de los equipos del arreglo
        foreach ($nuevosEquipos as $equipo) {
            $nuevoEquipoSerie = $equipo["NoSerie"];
            $nuevoEquipoModelo = $equipo["modelo"];
            $update_equipo_query = "UPDATE dispositivo SET modelo = '$nuevoEquipoModelo' WHERE NoSerie = '$nuevoEquipoSerie' AND id_Invitado = '$id_invi' and fecha = '$fechaFront' and horaInicio = '$horaInicioFront'";
    ...
    // Actualizar vehiculo
    //select para ver si existen equipos
    $select_checar_auto = "SELECT fecha, horaInicio FROM auto WHERE id_Invitado = '$id_invi' AND fecha = '$fechaFront' AND horaInicio = '$horaInicioFront'";
